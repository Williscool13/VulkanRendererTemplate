...
struct GLTFMetallic_RoughnessMultiDraw {
	...
	GLTFMetallic_RoughnessMultiDraw(MainEngine* engine, std::string& pathToScene, const char* vertShaderPath, const char* fragShaderPath, bool use_msaa, VkSampleCountFlagBits sample_count);
	...
	void update_draw_data(glm::mat4& model_matrix);
